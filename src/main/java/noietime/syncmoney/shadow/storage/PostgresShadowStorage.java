...
/**
 * PostgreSQL implementation of ShadowSyncStorage.
 *
 * [ThreadSafe] This class is thread-safe for concurrent operations.
 */
public final class PostgresShadowStorage implements ShadowSyncStorage {
    ...
    public PostgresShadowStorage(Plugin plugin, String host, int port, String username,
    ...
    private void createDatabaseIfNotExists() {
        try (HikariDataSource tempDs = createTempDataSource();
            ...
            String createDbSql = String.format(
                    ...
                    database);
            ResultSet rs = stmt.executeQuery(createDbSql);
    ...
    public void saveRecord(ShadowSyncRecord record) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            ps.setBoolean(7, record.isSuccess());
